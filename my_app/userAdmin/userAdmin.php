...
<html lang="en">
  ...
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="../../userAdminStyle/materialdesignicons.min.css">
    <link rel="stylesheet" href="../../userAdminStyle/vendor.bundle.base.css">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <!-- End plugin css for this page -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="../../userAdminStyle/style.css">
    <!-- End layout styles -->
  </head>
  ...
  <body>
          ...
          <div class="mdc-drawer__content">
            ...
            <div class="mdc-list-group">
              <nav class="mdc-list mdc-drawer-menu">
                ...
                <div class="mdc-list-item mdc-drawer-item">
                  <a class="mdc-drawer-link" href="../../userAdminStyle/basic-forms.html">
                    <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon"
                ...
                <div class="mdc-list-item mdc-drawer-item">
                  ...
                  <div class="mdc-expansion-panel" id="ui-sub-menu">
                    <nav class="mdc-list mdc-drawer-submenu">
                      <div class="mdc-list-item mdc-drawer-item">
                        <a class="mdc-drawer-link" href="../../userAdminStyle/buttons.html">
                          Buttons
                        </a>
                      </div>
                      <div class="mdc-list-item mdc-drawer-item">
                        <a class="mdc-drawer-link" href="../../userAdminStyle/typography.html">
                          Typography
                        </a>
                      </div>
                    </nav>
                ...
                <div class="mdc-list-item mdc-drawer-item">
                  <a class="mdc-drawer-link" href="../../userAdminStyle/basic-tables.html">
                    <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon"
                ...
                <div class="mdc-list-item mdc-drawer-item">
                  <a class="mdc-drawer-link" href="../../userAdminStyle/chartjs.html">
                    <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon"
                ...
                <div class="mdc-list-item mdc-drawer-item">
                  ...
                  <div class="mdc-expansion-panel" id="sample-page-submenu">
                    <nav class="mdc-list mdc-drawer-submenu">
                      <div class="mdc-list-item mdc-drawer-item">
                        <a class="mdc-drawer-link" href="../../userAdminStyle/blank-page.html">
                          Blank Page
                        </a>
                      </div>
                      <div class="mdc-list-item mdc-drawer-item">
                        <a class="mdc-drawer-link" href="../../userAdminStyle/403.html">
                          403
                        </a>
                      </div>
                      <div class="mdc-list-item mdc-drawer-item">
                        <a class="mdc-drawer-link" href="../../userAdminStyle/404.html">
                          404
                        </a>
                      </div>
                      <div class="mdc-list-item mdc-drawer-item">
                        <a class="mdc-drawer-link" href="../../userAdminStyle/500.html">
                          500
                        </a>
                      </div>
                      <div class="mdc-list-item mdc-drawer-item">
                        <a class="mdc-drawer-link" href="../../userAdminStyle/505.html">
                          505
                        </a>
                      </div>
                      <div class="mdc-list-item mdc-drawer-item">
                        <a class="mdc-drawer-link" href="../../userAdminStyle/login.html">
                          Login
                        </a>
                      </div>
                      <div class="mdc-list-item mdc-drawer-item">
                        <a class="mdc-drawer-link" href="../../userAdminStyle/register.html">
                          Register
                        </a>
                      </div>
                    </nav>
    ...
    <!-- plugins:js -->
    <script src="../../userAdminStyle/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page-->
    <!-- End plugin js for this page-->
    <!-- inject:js -->
    <script src="../../userAdminStyle/material.js"></script>
    <script src="../../userAdminStyle/misc.js"></script>
    <!-- endinject -->
